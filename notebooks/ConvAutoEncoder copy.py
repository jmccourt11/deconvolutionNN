...
for scan in tqdm(np.arange(884,1046)):
    try:
...
# Save summed diffraction patterns
np.save('/mnt/micdata2/12IDC/2024_Dec/RC02_R3D_884to1045_summed_diffraction_patterns.npy', summed_dps)
...
test=np.sum(dps,axis=0)[center[0]-dpsize//2:center[0]+dpsize//2,center[1]-dpsize//2:center[1]+dpsize//2]
