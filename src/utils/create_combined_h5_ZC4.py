...
def main():
    ...
    model_path = "/net/micdata/data2/12IDC/ptychosaxs/trained_model/best_model_ZC4_Unet_epoch_500_pearson_loss.pth"
    mask_path = '/home/beams/PTYCHOSAXS/deconvolutionNN/data/mask/mask_ZC4.npy' 
    ...
    # Output H5 file
    output_file = 'combined_diffraction_patterns_ZC4_TEST.h5'
    ...
    indices_file = "/home/beams/PTYCHOSAXS/NN/ptychosaxsNN/utils/ZC4_sample_indices.h5" 
...
# #%%
# with h5py.File('combined_diffraction_patterns_ZC4_TEST.h5', 'r') as f:
